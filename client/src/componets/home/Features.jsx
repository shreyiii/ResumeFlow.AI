...
const Features = () => {
  ...
  return (
        ...
        <div className="flex items-center gap-2 text-sm text-green-800 bg-green-400/10 border border-green-200 rounded-full px-4 py-1">
            <Zap width={15} height={15} className="text-green-600 " />
            <span>Save Time</span>
        </div>
        <Title title="Features" description="The core features of Resume Builder"/>
                    ...
                    <div className={"flex items-center justify-center gap-6 max-w-md group cursor-pointer"}>
                        <div className={`p-6 group-hover:bg-violet-100 border border-transparent group-hover:border-violet-300  flex gap-4 rounded-xl transition-colors ${!isHover ? 'border-violet-300 bg-violet-100' : ''}`}>
                            ...
                            <div className="space-y-2">
                                <h3 className="text-base font-semibold text-slate-700">ATS-Friendly Templates & Live Preview</h3>
                                <p className="text-sm text-slate-600 max-w-xs">Recruiter-ready templates built to pass ATS screening.</p>
                            </div>
                        </div>
                    </div>
                    <div className="flex items-center justify-center gap-6 max-w-md group cursor-pointer">
                        <div className="p-6 group-hover:bg-green-100 border border-transparent group-hover:border-green-300 flex gap-4 rounded-xl transition-colors">
                            ...
                            <div className="space-y-2">
                                ...
                                <p className="text-sm text-slate-600 max-w-xs">Leverage AI to optimize your resume for better visibility and higher chances of landing interviews.</p>
                            </div>
                        </div>
                    </div>
                    <div className="flex items-center justify-center gap-6 max-w-md group cursor-pointer">
                        <div className="p-6 group-hover:bg-orange-100 border border-transparent group-hover:border-orange-300 flex gap-4 rounded-xl transition-colors">
                            ...
                            <div className="space-y-2">
                                <h3 className="text-base font-semibold text-slate-700">Export Options</h3>
                                <p className="text-sm text-slate-600 max-w-xs">Export your resume in multiple formats (PDF, Word) for maximum compatibility.</p>
                            </div>
                        </div>
                    </div>
                </div>
