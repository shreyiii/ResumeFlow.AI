                                            ...
                                            <div className="text-gray-700 leading-relaxed mt-3 whitespace-pre-line">
                                                {typeof exp.description === 'string'
                                                    ...
                                                    : (Array.isArray(exp.description)
                                                        ? exp.description.map((d, i) => (typeof d === 'string' ? d : '')).filter(Boolean).join('\n')
                                                        : (typeof exp.description === 'object' && exp.description !== null
                                                            ? (typeof exp.description.text === 'string' ? exp.description.text : '')
                                                            : ''))}
                                            </div>
									)}
								</div>
									...
									<div className="text-gray-700 leading-relaxed text-sm mt-3">
										{typeof p.description === 'string'
											...
											: (Array.isArray(p.description)
												? p.description.map((d) => (typeof d === 'string' ? d : '')).filter(Boolean).join('\n')
												: (typeof p.description === 'object' && p.description !== null
													? (typeof p.description.text === 'string' ? p.description.text : '')
													: ''))}
									</div>
									)}
								</div>
