...
const CallToActions = () => {
  return (
    <div
      ...
      className="border-y border-dashed border-slate-200 w-full max-w-5xl mx-auto px-16 mt-20"
    >
      <div className="flex flex-col md:flex-row text-center md:text-left items-center justify-between gap-8 px-3 md:px-10 border-x border-dashed border-slate-200 py-20 -mt-10 -mb-10 w-full">
        <p className="text-xl font-medium max-w-sm">
          Build a professional resume in minutes with Resume Builder & Also Follow us on GitHub for more updates and features.
        </p>

        <a
          href="https://github.com/shreyiii"
          target="_blank"
